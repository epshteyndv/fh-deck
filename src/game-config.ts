...
export const characters: GameConfig = {
  ...
  "cr": {
    ...
    maxCards: 12,
    cards: [
      {"name": "fh-cleansing-swell" },
      {"name": "fh-crashing-surge" },
      {"name": "fh-cresting-force" },
      {"name": "fh-down-to-the-depths" },
      {"name": "fh-mighty-claws" },
      {"name": "fh-overwhelming-wave" },
      {"name": "fh-pool-of-power" },
      {"name": "fh-rancid-brine" },
      {"name": "fh-sharp-chitin" },
      {"name": "fh-skitter" },
      {"name": "fh-soft-flesh" },
      {"name": "fh-submerge" },
      {"name": "fh-crush-armor" },
      {"name": "fh-rising-flood" },
      {"name": "fh-undertow" },
      {"name": "fh-blood-in-the-water" },
      {"name": "fh-smashing-torrent" },
      {"name": "fh-endless-cycle" },
      {"name": "fh-shuck" },
      {"name": "fh-chaotic-refraction" },
      {"name": "fh-clean-sweep" },
      {"name": "fh-sodden-soil" },
      {"name": "fh-tidal-blast" },
      {"name": "fh-powerful-pincer" },
      {"name": "fh-twilight-grasp" },
      {"name": "fh-drown-beneath-the-waves" },
      {"name": "fh-dug-in" },
      {"name": "fh-death-on-all-sides" },
      {"name": "fh-ebb-and-flow" },
      {"name": "fh-high-tide" },
      {"name": "fh-low-tide" },
    ]
  },
  ...
  "me": {
    ...
    maxCards: 9,
    cards: [
      { "name": "fh-ancient-drill" },
      { "name": "fh-beam-axe" },
      { "name": "fh-memory-drive" },
      { "name": "fh-power-core" },
      { "name": "fh-pressure-build-up" },
      { "name": "fh-rocket-boots" },
      { "name": "fh-steam-armor" },
      { "name": "fh-steel-piston" },
      { "name": "fh-super-heat-transfer" },
      { "name": "fh-curious-gear" },
      { "name": "fh-processing" },
      { "name": "fh-recursion" },
      { "name": "fh-bronze-plating" },
      { "name": "fh-release-valve" },
      { "name": "fh-electrical-discharge" },
      { "name": "fh-stress-vents" },
      { "name": "fh-energy-conversion" },
      { "name": "fh-magnetic-field" },
      { "name": "fh-heat-conduction" },
      { "name": "fh-radiation" },
      { "name": "fh-scalding-blast" },
      { "name": "fh-steam-core" },
      { "name": "fh-cryogenic-hibernation" },
      { "name": "fh-heated-drill" },
